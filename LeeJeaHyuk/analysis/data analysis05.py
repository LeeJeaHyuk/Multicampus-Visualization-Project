...
sns.regplot(data = df , x=df['World Carbone Emission02'], y=df['Cat. 3+ Hurricanes'], ax=ax02)
plt.show()
...
fig03 = plt.figure()
ax06 = fig03.add_subplot(2,1,1)
ax07 = fig03.add_subplot(2,1,2)
sns.lineplot(data = df , x=df['Year'], y=df['Cat. 3+ Hurricanes'], ax=ax06)
sns.lineplot(data = df , x=df['Year'], y=df['World Carbone Emission02'], ax=ax07)
plt.show()
